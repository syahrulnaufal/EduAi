...
const Search = ({searchTerm, setSearchTerm, children}) => {
    ...
    return(
        <div className="search bg-white rounded-xl p-4 shadow-sm flex flex-col sm:flex-row gap-4 sm:gap-2">
            <div className="relative flex items-center">
                ...
                <input
                    ...
                    className='flex-1 rounded-full px-4 ps-10 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition-colors duration-300 
                            ...
                            text-my-text placeholder-gray-200 border-gray-200 focus:border-indigo-300 shadow-sm
                            border '
                    type="text"
