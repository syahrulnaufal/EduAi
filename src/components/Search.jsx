...
const Search = ({searchTerm, setSearchTerm, children}) => {
    ...
    return(
        <div className="search bg-white rounded-xl p-4 shadow-sm flex flex-col border border-gray-100 sm:flex-row gap-4 sm:gap-2 w-full" style={{boxShadow: '0px 6px 20px 4px rgba(113, 130, 164, 0.24)'}}>
